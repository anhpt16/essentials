...
public class WebEssentialPostControllerService {
    ...
    public List<WebMostVotePostResponse> getMostVotePosts() {
        List<MostVotePostModel> posts = essentialPostService.getMostVotePosts(NUMBER_OF_MOST_VOTE_POSTS);
        return essentialPostModelDecorator.decorateMostVotePosts(posts);
    }

    public List<WebMostVotePostResponse> getFooterMostVotePosts() {
        List<MostVotePostModel> posts = essentialPostService.getMostVotePosts(NUMBER_OF_MOST_VOTE_POSTS_FOOTER);
        return essentialPostModelDecorator.decorateMostVotePosts(posts);
    }

    public List<WebLatestPostResponse> getLatestPosts() {
        List<LatestPostModel> posts = essentialPostService.getLatestPosts();
        return essentialPostModelDecorator.decorateLatestPosts(posts);
    }
}
